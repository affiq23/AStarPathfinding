...
public class AStar {
    ...
    private int cells = (int)(Math.random() * 41) + 10;
    ...
    // 0     1          2       3         4
    private String[] tools = {"Start point", "Finish point", "Wall option", "Eraser option", "Draw"};
    //BOOLEANS
    ...
    //BUTTONS
    JButton searchB = new JButton("Solve It");
    JButton resetB = new JButton("Reset");
    JButton genMapB = new JButton("Map Generator");
    JButton clearMapB = new JButton("Clear the Map");
    JButton clueB = new JButton("Clue Button");
    //DROP DOWN
    ...
    public AStar() throws FileNotFoundException {    //CONSTRUCTOR
        clearMap();
        generateMap();
        PrintStream o = new PrintStream(new File("ExportData.txt"));
    ...
    public String getDimensions() {
        String dim = String.valueOf(cells);
        return "Dimensions: " + dim + " x " + dim;
    }

    public String getDensity() {
        String den = String.valueOf((int) density);
        return "Black Boxes: " + den;
    }
    ...
    private void initialize() {    //INITIALIZE THE GUI ELEMENTS
        ...
        clueB.setBounds(40, space, 120, 25);
        toolP.add(clueB);
        ...
        clueB.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                reset();
                if ((startx > -1 && starty > -1) && (finishx > -1 && finishy > -1)) {
    ...
    public void Update() {    //UPDATE ELEMENTS OF THE GUI
        ...
        System.out.println("Density: " + obstacles.getValue() + "%");
        ...
        public void mousePressed(MouseEvent e) {
            ...
            try {
                ...
                switch (tool) {
                    ...
                    // Node Type
                    // 0 = start, 1 = finish, 2 = wall, 3 = empty, 4 = checked, 5 = finalpath, 6 = userpath
                    case 4: { //USERPATH
                        //System.err.println("** Tool: " + tool + " Node Type: " + current.getType());
